...
# BASE_DIR="models/recipenlg/mode=random_samples/bs=8/prompt=step_token_pairs/attn=full/loss=completion_only/clm=0/kl=0/mml=0/pos=0/stp=1/eos_init=0/use_lora=0/act=real/gpt2"
...
python src/cat_bench_regression_step_tokens.py \
    --model_dir "$model_dir" \
